    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] w-full p-6 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 flex flex-col gap-4">
                ...
                >
                    {/* Passed scroll container ref to the component which wraps the scrollable area, 
                        BUT TestsDueTable currently handles its own scrolling internally. 
                        We need to attach the ref to the SCROLLABLE element inside TestsDueTable OR 
                        allow TestsDueTable to bubble up the scroll event. 
                        
                        Actually, existing TestsDueTable has internal div with `flex-1 overflow-y-auto`.
                        We should modify TestsDueTable to accept an `onScroll` prop or `ref`.
                        
                        Better yet: Wrap the TABLE part in Dashboard if possible? No, the table component encapsulates structure.
                        
                        Let's Modify TestsDueTable to expose the scroll handler.
                    */}
                    <TestsDueTable
                        tests={tests}
